    ...
    <>
      ...
      >
        <div className="text-white mb-8 font-inter">
          ...
          <p className="text-xs font-extralight">{dateToday}</p>
        </div>
        <div className="mb-16">
          {tasks.map((task) =>
            !task.completed && task.dateOfRealisation === TodayIsoDate ? (
              <div className="bg-gray-100 rounded shadow p-2 mb-3 flex justify-between">
                ...
                <div className="flex items-center content-center">
                  <p className="font-normal">Aujourd'hui</p>
              ...
              task.completed && task.dateOfRealisation === TodayIsoDate ? (
                <div className="bg-white rounded shadow p-2 mb-3 flex justify-between items-center">
                  <div className="flex items-center">
                    <button className="mx-2 rounded-full text-blue-600 ">
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="18"
                        height="18"
                  ...
                  <div className="flex items-center content-center">
                    <p className="font-normal">
                      Aujourd'hui, {hourformat(task.updated_at)}
                    </p>
                    <div>
                      <DropdownMenu>
                        ...
                        <DropdownMenuContent className="w-56 rounded text-xs bg-white">
                          ...
                          <DropdownMenuGroup>
                            <DropdownMenuItem
                              className="active:bg-slate-200 rounded focus:bg-slate-100"
                              onClick={() => ""}
                              disabled
                            >
                              Marque comme terminé
