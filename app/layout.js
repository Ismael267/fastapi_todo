    ...
    fetch("http://127.0.0.1:8000/tasks", {
      ...
      .then((data) => {
        ...
        console.log(TodayIsoDate);
           ...
           // Supposons que data soit un tableau d'objets avec une propriété 'dateOfRealisation'
      const filteredData = data.filter((item) => {
        const itemDate = item.dateOfRealisation;
      ...
      <body className={inter.className}>
        <main className="">
          <div className="flex  min-h-screen font-inter ">
            <div
              className="px-3 py-6 bg-blue-50 w-full md:w-60  flex-col md:flex hidden  justify-between"
              id="sidebar"
            >
              <div>
                ...
                <ul className="text-blue-900 font-medium font-inter text-base mt-4 ">
                  <Link href="/">
                    <li className="mb-2 m-0 p-2 flex  active:text-white active:bg-blue-500 hover:text-white hover:fill-white   hover:fill-white   hover:bg-blue-500 focus:text-white rounded-lg text-sm items-center">
                      <div className="flex w-full justify-between items-center">
                        <div className="flex content-end">
                          <svg
                            ...
                            className="fill-current hover:fill-current  transition-colors duration-300"
                          >
                            <path
                  ...
                  <Link href="/Avenir">
                    <li className="mb-2 p-2 m-0 flex active:text-white active:bg-blue-500 hover:bg-blue-500 hover:text-white focus:text-white rounded-lg text-sm items-center">
                  ...
                  <Link href="/tache">
                    <li className="mb-2 p-2 m-0 flex active:text-white active:bg-blue-500 hover:bg-blue-500 hover:text-white fill-blue-200-accent  focus:text-white rounded-lg text-sm items-center hover:fill-white ">
                      <div className="flex  w-full justify-between items-center content-center">
                        <div className="flex">
                          <svg
                            width="14"
