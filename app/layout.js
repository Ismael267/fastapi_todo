      ...
      <body className={inter.className}>
        <main className="">
          <div className="flex  min-h-screen max-md:h-full font-inter relative ">
            {menuVisible && (
              <div className=" max-md:w-full bg-blue-400/10 max-md:absolute max-md:h-full max-md:backdrop-blur-sm justify-between z-50 focus:ring-4 pointer-events-none	 ">
                <div
