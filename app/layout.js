  ...
  return (
    <html lang="en">
      <body className={inter.className}>
        <main className="">
          <div className="flex min-h-screen max-md:h-full font-inter relative ">
            {menuVisible && (
              <div className="md:hidden  max-md:w-full bg-blue-400/10 max-md:absolute max-md:flex max-md:h-full max-md:backdrop-blur-sm justify-between z-50 focus:ring-4 pointer-events-none	 ">
                <div
                  className=" max-md:pt-10 pl-3  px-3 py-6 h-full  bg-blue-50 max-md:w-3/4 md:w-60 flex-col max-md:h-full justify-between flex max-md:justify-between pointer-events-auto max-md:transition-transform max-md:ease-in-out max-md:duration-900"
                  id="sidebar"
                >
                  <div>
                    <div className="flex items-center mb-5 text-blue-600	">
                      ...
                      <h1 className=" pl-1 font-inter  text-2xl font-extrabold ">
                        My Todo
                      </h1>
                    </div>
                    <ul className="text-blue-900 font-medium font-inter text-base mt-4 transition-colors duration-300">
                      <Link href="/">
                        <li className="mb-2 m-0 p-2 flex md:active:text-white group active:bg-blue-500 hover:text-white hover:fill-white hover:bg-blue-500 focus:text-white focus:ring rounded-lg text-sm items-center">
            ...
            <div className=" max-md:hidden max-md:w-full bg-blue-400/10 max-md:absolute  max-md:h-full max-md:backdrop-blur-sm justify-between z-50 focus:ring-4 pointer-events-none	 ">
              <div
                className=" max-md:pt-10 pl-3  px-3 py-6 h-full  bg-blue-50 max-md:w-3/4 md:w-60 flex-col max-md:h-full justify-between flex max-md:justify-between pointer-events-auto max-md:transition-transform max-md:ease-in-out max-md:duration-900"
                id="sidebar"
              >
            ...
            >
              <div className="bg-blue-50 flex rounded-lg items-center md:hidden font-inter text-blue-600 p-2  mb-6 shadow-2xl shadow-black max-md:flex">
